  ...
  <body>
    <div class="maincont">
     ...
     <div id="sliderA" class="slider">
      <img src="{{env ('IMG')}}{{$data->goods_img}}" />
     ...
     <div class="proinfoList">
      <img src="{{env ('IMG')}}{{$data->goods_img}}" width="636" height="822" />
     </div><!--proinfoList/-->
     <div class="proinfoList">
      暂无信息....
     </div><!--proinfoList/-->
     ...
     <table class="jrgwc">
      <tr>
       ...
       <td><a class="car" href="javascript:view(0)">加入购物车</a></td>
      </tr>
     </table>
    </div><!--maincont-->
  ...
  $('.spinnerExample').spinner({});
    $('.increase').click(function(){
      ...
      if(number==goods_number){
        alert('库存不足');
      $('.spinnerExample').val(goods_number);
      }else{
        $('.spinnerExample').val(goods_number);
      }
    })
