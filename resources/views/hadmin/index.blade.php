...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="{{asset('hadmin/css_animation.html')}}"><i class="fa fa-magic"></i> <span class="nav-label">CSS动画</span></a>
                </li>
                <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="{{asset('hadmin/index_v1.html?v=4.0')}}" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
    </div>
    <!--右侧部分结束-->
</div>
...
<script type="{{asset('hadmin/text/javascript" src="js/index.js')}}"></script>
